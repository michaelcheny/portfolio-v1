    ...
    <section className="h-screen max-w-screen-lg mx-auto">
      <div>
        ...
        <p className="text-gray-400">
          ...
          there, how much of that did you hear? Do you know how many characters there are in the Simpsons
          Morty? There's like a-a billion characters, M-Morty. There was an episode where Former
          President BUSH was their neighbor!
        </p>
      </div>
    </section>
  );
