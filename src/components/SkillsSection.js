...
const SkillsSection = () => {
  return (
    <section id="skills" className="flex flex-col h-half border border-dracula6">
      <div className="mx-16 my-auto flex flex-row  flex-wrap justify-between border border-dracula5">
        ...
        <a target="_blank" rel="noopener noreferrer" href="https://icons8.com/icons/set/css3">
          <img src={Css} alt="CSS Language Icon" title="CSS" className="flex h-10 sm:h-16" />
        </a>

        <a target="_blank" rel="noopener noreferrer" href="https://icons8.com/icons/set/sql">
          <img src={Sql} alt="Sql Icon" title="SQL" className="flex h-10 sm:h-16" />
        </a>
        ...
        >
          <img src={Ruby} alt="Ruby Programming Icon" title="Ruby" className="flex h-10 sm:h-16" />
        </a>

        <img src={Rails} alt="Rails Programming Icon" title="Rails" className="flex h-10 sm:h-16" />
        ...
        <a target="_blank" rel="noopener noreferrer" href="https://icons8.com/icons/set/redux">
          <img src={Redux} alt="Redux Programming Icon" title="Redux" className="flex h-10 sm:h-16" />
        </a>

        <a target="_blank" rel="noopener noreferrer" href="https://icons8.com/icons/set/git">
          <img src={Git} alt="Git Icon" title="Git" className="flex h-10 sm:h-16" />
        </a>
      </div>
